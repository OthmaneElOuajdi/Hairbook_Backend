    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/public-holidays/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/refunds").hasAnyRole("CLIENT", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/refunds/my-requests").hasAnyRole("CLIENT", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/refunds/files/**").hasAnyRole("CLIENT", "ADMIN")
                        .requestMatchers("/api/v1/refunds/pending").hasRole("ADMIN")
                        .requestMatchers("/api/v1/refunds/*/approve").hasRole("ADMIN")
                        .requestMatchers("/api/v1/refunds/*/reject").hasRole("ADMIN")
                        .requestMatchers("/api/v1/refunds/*/mark-refunded").hasRole("ADMIN")
