 ...
 * - Null/blank est considéré comme valide : utilisez @NotBlank/@NotNull pour
 * contraindre la présence.
 * <p>
 * Exemples valides :
 * <ul>
...
public @interface ValidBelgianPhone {
    ...
    String message() default "Le numéro de téléphone doit être un numéro belge valide (ex: +32 4XX XX XX XX ou 04XX XX XX XX)";
    ...
    class BelgianPhoneValidator implements ConstraintValidator<ValidBelgianPhone, String> {
        ...
        public boolean isValid(String phoneNumber, ConstraintValidatorContext context) {
            ...
            return mobileOnly
                    ? validationService.validateBelgianMobileNumber(phoneNumber)
                    : validationService.validateBelgianPhoneNumber(phoneNumber);
        }
    }
}
