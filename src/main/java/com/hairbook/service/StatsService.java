...
public class StatsService {
     ...
     *   <li>Le nombre de nouveaux clients créés sur la période</li>
     * </ul>
     * <p>
    ...
    public StatsDto getWeeklyStats(LocalDateTime startOfWeek, LocalDateTime endOfWeek) {
        ...
        // Note: Les rendez-vous annulés suite à un remboursement ne sont pas comptés
        // dans sumRevenueBookedCents car ils ont le statut CANCELLED.
        // Pas besoin de soustraire à nouveau les remboursements.

        Long newClientsCount = userRepository.countNewClientsBetween(startOfWeek, endOfWeek);
        if (newClientsCount == null) newClientsCount = 0L;
